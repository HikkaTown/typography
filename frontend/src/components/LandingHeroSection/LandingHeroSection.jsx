...
export const star = (className) => {
    return (
        <svg className={cs(style.star, className)} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <AnimatePresence>
                {
                    isOpenModal && (
                        <FeedbackModal 
                            ...
                            file={false} 
                            visibleOffice={false} 
                            placeholderComment={'Нужен сайт-визитка для барбершопа'}
                            theme={'Разработка сайта обратная связь'}
                        />
                    )
                }
            </AnimatePresence>
