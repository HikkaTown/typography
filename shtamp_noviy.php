		...
		<div class="uk-grid uk-grid-divider" uk-grid>
			...
			<div class="uk-width-1-1 uk-width-expand@s">
				<ul class="uk-breadcrumb">
					...
					<li><span>Новый штамп</span></li>
				</ul>
				<section class="s-content"><!-- основной контент -->
					<header>
						<h1 class="uk-heading-divider">Новый штамп <br><span>Цветной бульвар, Кузнецкий мост, Новокузнецкая,  Третьяковская, Чистые пруды</span></h1>
						<div class="img-container">
							<img src="img/glavnie/faksimile2.jpg">
							<div class="img-text">
								<h4>Новый штамп от 400 руб</h4>
						...
						<p class="uk-text-meta uk-text-small">Штампы это инструмент служащий для упрощения работы с документами. Штамп состоит из двух частей матрицы (оттиска) и оснастки. Оснастка может быть простой и автоматической. Простая оснастка входит в стоимость штампа. Автоматическая оснастка оплачивается отдельно.</p>
					...
					<div class="uk-section-small"><!-- Цифровая печать -->
						<a name="visitki_1"></a>
						<h2>Как заказать новую штамп в 3 простых шага</h2>
						<div class="divider-header">
							<h3>Выберете оснастку для вашего новго штампа</h3>
						...
						<form id="PpcForm2">
							...
							<div id="simple_osnactki" class="osnastki_content active">
								...
								<div class="uk-child-width-1-2@l uk-child-width-1-2@m uk-child-width-1-2@s uk-grid-small very-small" uk-grid uk-lightbox="animation: scale">
									<div class="radio-group" id="radio-group1">
										<input type="radio" class="inprad" name="ostanka" value="Оснастка №1" id="simple1">
										<label for="simple1">
											<div>
												<img src="img/pechati/osnastki/manual_1.jpg" >
												<p class="name_of_shtampmain">Оснастка №1</p>
											</div>
											<div>
							...
							<div class="step2">
								<div class="divider-header">
									<h3>Выберете дизайн-макет вашего нового штампа</h3>
									<span class="step-number">2</span>
								</div>
								<div class="uk-child-width-1-3@l uk-child-width-1-2@m uk-child-width-1-2@s uk-grid-small my-grid shtamps" uk-grid uk-lightbox="animation: scale">
									<div class="radio-group" id="radio-group1">
										<input type="radio" class="inp-radio" name="design" value="Маленький штамп до 10 мм / 30 мм в 1 строку" id="design1">
										<label for="design1">
											<div>
												<img src="img/pechati/shtamp/type1.png" >
												<p class="name_of_shtamp">Маленький штамп <br>до 10 мм / 30 мм <br>в 1 строку</p>
											</div>
										</label>
									</div>
									<div class="radio-group" id="radio-group1">
										<input type="radio" class="inp-radio" name="design" value="Средний штамп до 20 мм / 50 мм до 4 строк" id="design2">
										<label for="design2">
											<div>
												<img src="img/pechati/shtamp/type2.png" >
												<p class="name_of_shtamp">Средний штамп <br>до 20 мм / 50 мм <br>до 4 строк</p>
											</div>
										</label>
									</div>
									<div class="radio-group" id="radio-group1">
										<input type="radio" class="inp-radio" name="design" value="Большой штамп до 60 мм / 90 мм до 10 строк" id="design3">
										<label for="design3">
											<div>
												<img src="img/pechati/shtamp/type3.png" >
												<p class="name_of_shtamp">Большой штамп <br>до 60 мм / 90 мм <br>до 10 строк</p>
											</div>
										</label>
									</div>
								</div>
							...
							<div class="step3">
								<div class="divider-header">
									<h3>Введите данные для штампа</h3>
									<span class="step-number">3</span>
								</div>
								<div class="uk-child-width-1-2@l uk-child-width-1-2@m uk-child-width-1-2@s uk-grid-small" uk-grid uk-lightbox="animation: scale">
									<div>
										<div class="input-inp">
											<label for="input">Строка 1</label>
											<input type="text" id="input" name="stroka1">
										</div>
										<div class="input-inp">
											<label for="input">Строка 2</label>
											<input type="text" id="input" name="stroka2">
										</div>
										<div class="input-inp">
											<label for="input">Строка 3</label>
											<input type="text" id="input" name="stroka3">
										</div>
										<div class="input-inp">
											<label for="input">Строка 4</label>
											<input type="text" id="input" name="stroka4">
										</div>
										<div class="input-inp">
											<label for="input">Строка 5</label>
											<input type="text" id="input" name="stroka5">
										</div>
									</div>
									<div>
										<div class="input-inp">
											<label for="input">Строка 6</label>
											<input type="text" id="input" name="stroka6">
										</div>
										<div class="input-inp">
											<label for="input">Строка 7</label>
											<input type="text" id="input" name="stroka7">
										</div>
										<div class="input-inp">
											<label for="input">Строка 8</label>
											<input type="text" id="input" name="stroka8">
										</div>
										<div class="input-inp">
											<label for="input">Строка 9</label>
											<input type="text" id="input" name="stroka9">
										</div>
										<div class="input-inp">
											<label for="input">Строка 10</label>
											<input type="text" id="input" name="stroka10">
										</div>
									</div>
								</div>
							</div><br><br>
							<div class="step4">
								...
								<div class="input-group">
									...
									<input type="text" class="fio" id="name" name="name_shtamp">
								</div>
								<div class="input-group">
									<label for="phone">Телефон для связи</label>
									<input type="text" id="phone" placeholder="+7 906 733 39 17" name="phone">
								</div>
								<div class="input-group">
									<label for="email">Почта что бы мы отправили вам макет печати перед изготовлением</label>
									<input type="email" class="mail" id="email" placeholder="1ppc@mail.ru" name="email">
								</div><br>
								<div class="vivod">
									<div class="vibor">
