		...
		<div class="uk-grid uk-grid-divider" uk-grid>
			...
			<div class="uk-width-1-1 uk-width-expand@s">
				<ul class="uk-breadcrumb">
					...
					<li><span>Факсимиле</span></li>
				</ul>
				<section class="s-content"><!-- основной контент -->
					<header>
						<h1 class="uk-heading-divider">Факсимиле <br><span>Цветной бульвар, Кузнецкий мост, Новокузнецкая,  Третьяковская, Чистые пруды</span></h1>
						<div class="img-container">
							<img src="img/glavnie/faksimile2.jpg">
							<div class="img-text">
								<h4>Факсимиле от 500 руб</h4>
						...
						<p class="uk-text-meta uk-text-small">Это точная копия подписи со всеми особеностями. Факсимиле сильно упрощает работу, когда нужно поставить подпись на большое количество документов, или когда нужная подпись нужна сдесь и сейчас а самого человека рядом нет. Рекомендуем делать факсимиле на автоматической оснатске, так будет гарантия одинакового оттиска раз за разом, оснастка убирает ручные погрешности при нажатии. Простая оснастка входит в стоимость факсимиле. Если у вас мало времени приходить к нам в офис, можете отправить скан подписа на почту, а курьер доставит факсимиле куда скажите.</p>
					...
					<div class="uk-section-small"><!-- Цифровая печать -->
						<a name="visitki_1"></a>
						<h2>Как заказать факсимиле в 2 простых шага</h2>
						<div class="divider-header">
							<h3>Выберете оснастку для вашего факсимиле</h3>
						...
						<form action="shtamp_faksimilye.php" enctype="multipart/form-data" method="post">
							...
							<div class="step2">
								<div class="divider-header">
									<h3>Прикрепите скан факсимиле</h3>
