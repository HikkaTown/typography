...
$(document).ready(function(){$("a[href='#callback']").click(function(){var a=$(this).data("form"),e=$(this).data("text");$(".form-callback h3").text(e),$(".form-callback [name=admin_data]").val(a)}),$(".form-callback").submit(function(){var a=$(this);return $.ajax({type:"POST",url:"mail.php",data:a.serialize()}).done(function(){$(a).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(a).find(".success").removeClass("active").fadeOut(),a.trigger("reset")},1e3)}),!1})}),$(window).on("load",function(){$(".preloader").delay(500).fadeOut()});